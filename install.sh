...
echo 'alias triestecoin="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/munich/19.git" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/munich/19.git'"
...
rm -rf "$HOME/.config/@triestecoin"
rm -rf "$HOME/.config/@triestecoin"
rm -rf "$HOME/.config/triestecoin-core"
